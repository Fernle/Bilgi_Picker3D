...
{
    public class ForceBallsToPoolCommand : ICommand
    {
        ...
        public void Execute()
        {
            ...
            var forcePos = new Vector3(position.x, position.y - 1.2f, position.z + 1f);

            var collider = Physics.OverlapSphere(forcePos, 1.05f /*.83f*/);
